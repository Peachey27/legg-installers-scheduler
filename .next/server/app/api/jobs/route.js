"use strict";(()=>{var e={};e.id=204,e.ids=[204],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},4770:e=>{e.exports=require("crypto")},7553:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>E,patchFetch:()=>N,requestAsyncStorage:()=>_,routeModule:()=>m,serverHooks:()=>L,staticGenerationAsyncStorage:()=>b});var s={};r.r(s),r.d(s,{GET:()=>T,POST:()=>p,runtime:()=>c});var a=r(9303),n=r(8716),o=r(670),l=r(7070),i=r(3075),d=r(3887),u=r(4770);let c="nodejs";async function T(e){try{let e=await i.db.select().from(d.jobs);return l.NextResponse.json(e,{status:200})}catch(e){return console.error("GET /api/jobs failed",e),l.NextResponse.json({error:String(e)},{status:500})}}async function p(e){try{let t=await e.json(),r=new Date().toISOString().slice(0,10),s={id:(0,u.randomUUID)(),clientName:t.clientName??"",clientAddress:t.clientAddress??"",clientPhone:t.clientPhone??"",billingAddress:t.billingAddress??t.clientAddress??"",jobAddress:t.jobAddress??"",dateTaken:t.dateTaken??r,totalPrice:t.totalPrice??null,description:t.description??"",invoiceNumber:t.invoiceNumber??null,estimateNumber:t.estimateNumber??null,cashSaleNumber:t.cashSaleNumber??null,measurements:t.measurements??null,glassOrProductDetails:t.glassOrProductDetails??null,quotedRange:t.quotedRange??null,internalNotes:t.internalNotes??null,assignedDate:t.assignedDate??null,estimatedDurationHours:t.estimatedDurationHours??null,crew:t.crew??null,areaTag:t.areaTag??"Other",status:t.status??"backlog",factoryJobId:t.factoryJobId??null,photo1Url:t.photo1Url??null,photo2Url:t.photo2Url??null,photo3Url:t.photo3Url??null,deletedAt:null},a=["clientName","clientAddress","jobAddress","description"].filter(e=>!s[e]);if(a.length)return l.NextResponse.json({error:`Missing required fields: ${a.join(", ")}`},{status:400});return await i.db.insert(d.jobs).values(s),l.NextResponse.json(s,{status:201})}catch(e){return console.error("Create job failed",e),l.NextResponse.json({error:String(e)},{status:500})}}let m=new a.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/jobs/route",pathname:"/api/jobs",filename:"route",bundlePath:"app/api/jobs/route"},resolvedPagePath:"C:\\Users\\Michael\\Desktop\\Installer App\\src\\app\\api\\jobs\\route.ts",nextConfigOutput:"",userland:s}),{requestAsyncStorage:_,staticGenerationAsyncStorage:b,serverHooks:L}=m,E="/api/jobs/route";function N(){return(0,o.patchFetch)({serverHooks:L,staticGenerationAsyncStorage:b})}},3075:(e,t,r)=>{r.d(t,{db:()=>d});var s=r(5096);let a=require("better-sqlite3");var n=r.n(a),o=r(3887);let l=process.env.DATABASE_FILENAME??(process.env.VERCEL?"/tmp/installer_scheduler.db":"installer_scheduler.db"),i=new(n())(l);!function(e){e.prepare("SELECT name FROM sqlite_master WHERE type='table' AND name='jobs'").get()||e.exec(`
