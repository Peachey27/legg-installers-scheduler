"use strict";(()=>{var e={};e.id=301,e.ids=[301],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},2161:(e,t,a)=>{a.r(t),a.d(t,{originalPathname:()=>f,patchFetch:()=>N,requestAsyncStorage:()=>L,routeModule:()=>c,serverHooks:()=>b,staticGenerationAsyncStorage:()=>E});var r={};a.r(r),a.d(r,{DELETE:()=>_,GET:()=>T,PUT:()=>p});var s=a(9303),o=a(8716),n=a(670),i=a(7070),d=a(6687),l=a(3887),u=a(7745);async function T(e,{params:t}){let[a]=await d.db.select().from(l.jobs).where((0,u.eq)(l.jobs.id,t.id));return!a||a.deletedAt?i.NextResponse.json({error:"Not found"},{status:404}):i.NextResponse.json(a)}async function p(e,{params:t}){let a=await e.json();return await d.db.update(l.jobs).set(a).where((0,u.eq)(l.jobs.id,t.id)),i.NextResponse.json({ok:!0})}async function _(e,{params:t}){return await d.db.update(l.jobs).set({deletedAt:new Date().toISOString()}).where((0,u.eq)(l.jobs.id,t.id)),i.NextResponse.json({ok:!0})}let c=new s.AppRouteRouteModule({definition:{kind:o.x.APP_ROUTE,page:"/api/jobs/[id]/route",pathname:"/api/jobs/[id]",filename:"route",bundlePath:"app/api/jobs/[id]/route"},resolvedPagePath:"C:\\Users\\Michael\\Desktop\\Installer App\\src\\app\\api\\jobs\\[id]\\route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:L,staticGenerationAsyncStorage:E,serverHooks:b}=c,f="/api/jobs/[id]/route";function N(){return(0,n.patchFetch)({serverHooks:b,staticGenerationAsyncStorage:E})}},6687:(e,t,a)=>{a.d(t,{db:()=>l});var r=a(5096);let s=require("better-sqlite3");var o=a.n(s),n=a(3887);let i=process.env.DATABASE_FILENAME??"installer_scheduler.db",d=new(o())(i);d.exec(`
